...
<root xmlns="http://www.vips.ecs.soton.ac.uk/nip/7.33.0">
  ...
  <Workspace window_x="365" window_y="109" window_width="710" window_height="866" view="WORKSPACE_MODE_REGULAR" scale="1" offset="0" lpane_position="652" lpane_open="false" rpane_position="100" rpane_open="false" local_defs="// private definitions for this workspace&#10;&#10;Match a b = class &#10;    _result {&#10;    _vislevel = 3;&#10;&#10;&#9;reference = copy a;&#10;&#9;adjust = copy b;&#10;&#10;&#9;ap1 = Mark_relative reference 0.25 0.25;&#10;    ap2 = Mark_relative reference 0.75 0.75;&#10;    bp1 = Mark_relative adjust 0.25 0.25;&#10;    bp2 = Mark_relative adjust 0.75 0.75;&#10;&#10;&#9;test_alignment = _result?1 ++ reference?1 ++ 0;&#10;&#10;    _result&#10;        = Image (im_match_linear reference.value adjust.value&#10;                ap1.left ap1.top bp1.left bp1.top&#10;                ap2.left ap2.top bp2.left bp2.top);&#10;}   &#10;&#10;Match_default default a b = class &#10;    _result {&#10;    _vislevel = 3;&#10;&#10;&#9;reference = copy a;&#10;&#9;adjust = copy b;&#10;&#10;&#9;ap1 = Mark reference default.ap1.left default.ap1.top;&#10;    ap2 = Mark reference default.ap2.left default.ap2.top;&#10;    bp1 = Mark adjust default.bp1.left default.bp1.top;&#10;    bp2 = Mark adjust default.bp2.left default.bp2.top;&#10;&#10;&#9;test_alignment = _result?1 ++ reference?1 ++ 0;&#10;&#10;    _result&#10;        = Image (im_match_linear reference.value adjust.value&#10;                ap1.left ap1.top bp1.left bp1.top&#10;                ap2.left ap2.top bp2.left bp2.top);&#10;}&#10;&#10;Pair_match a b = class {&#10;&#9;_vislevel = 2;&#10;&#10;&#9;label = &quot;adjust &quot; ++ b.label ++ &quot; to match &quot; ++ a.label;&#10;&#9;targets = Match a.targets b.targets;&#10;&#9;object = Match a.object b.object;&#10;}&#10;&#10;Pair_match_default default a b = class {&#10;&#9;_vislevel = 2;&#10;&#10;&#9;label = &quot;adjust &quot; ++ b.label ++ &quot; to match &quot; ++ a.label;&#10;&#9;targets = Match_default default.targets a.targets b.targets;&#10;&#9;object = Match_default default.object a.object b.object;&#10;}&#10;" name="align" caption="align all images" filename="$HOME/GIT/bm-workspaces/bm-workspaces2.ws">
              ...
              <Row name="object">
                <Rhs vislevel="3" flags="7">
                  ...
                  <Subcolumn vislevel="1">
                    ...
                    <Row name="reference">
                      <Rhs vislevel="1" flags="1">
                        <iImage window_x="971" window_y="47" window_width="750" window_height="750" image_left="376" image_top="168" image_mag="8" show_status="true" show_paintbox="false" show_convert="false" show_rulers="false" scale="1" offset="0" falsecolour="false" type="true"/>
                        <Subcolumn vislevel="0"/>
                        <iText/>
                      </Rhs>
                    </Row>
                    <Row name="adjust">
                      <Rhs vislevel="1" flags="1">
                        <iImage window_x="548" window_y="191" window_width="750" window_height="750" image_left="389" image_top="180" image_mag="8" show_status="true" show_paintbox="false" show_convert="false" show_rulers="false" scale="1" offset="0" falsecolour="false" type="true"/>
                        <Subcolumn vislevel="0"/>
                        <iText/>
                      </Rhs>
                    </Row>
                    <Row name="ap1">
                      <Rhs vislevel="1" flags="1">
                        <iArrow left="376" top="160" width="0" height="0">
                          <iRegiongroup/>
                        </iArrow>
                        <Subcolumn vislevel="0"/>
                        <iText/>
                    ...
                    <Row name="bp1">
                      <Rhs vislevel="1" flags="1">
                        <iArrow left="381" top="165" width="0" height="0">
                          <iRegiongroup/>
                        </iArrow>
                        <Subcolumn vislevel="0"/>
                        <iText/>
                    ...
                    <Row name="test_alignment">
                      <Rhs vislevel="2" flags="5">
                        <iImage window_x="23" window_y="416" window_width="750" window_height="750" image_left="387" image_top="148" image_mag="8" show_status="true" show_paintbox="false" show_convert="false" show_rulers="false" scale="1" offset="0" falsecolour="false" type="true"/>
                        <Subcolumn vislevel="0"/>
                        <iText formula="_result?1 ++ reference?0 ++ reference?1"/>
                      </Rhs>
                    </Row>
                  </Subcolumn>
                  <iText/>
    ...
    <Column x="559" y="0" open="true" selected="false" sform="false" next="7" name="E" caption="match UV to vis">
      <Subcolumn vislevel="3">
    ...
    <Column x="1079" y="0" open="true" selected="false" sform="false" next="6" name="G" caption="match UV-induced visible luminescence to vis">
      <Subcolumn vislevel="3">
    ...
    <Column x="1684" y="0" open="true" selected="true" sform="false" next="9" name="H" caption="match vis-induced IR luminescence to vis">
      <Subcolumn vislevel="3">
  ...
  <Workspace window_x="365" window_y="109" window_width="710" window_height="866" view="WORKSPACE_MODE_REGULAR" scale="1" offset="0" lpane_position="74" lpane_open="true" rpane_position="400" rpane_open="false" local_defs="// private definitions for this workspace&#10;&#10;Pair l a b = class&#10;    _Object {&#10;&#9;_vislevel = 2;&#10;&#10;&#9;label = l;&#10;&#9;targets = a;&#10;&#9;object = b;&#10;&#9;&#10;    oo_binary_table op x = [&#10;        [this.Pair label (op.fn a x) (op.fn b x),&#10;            true]&#10;    ];&#10;&#9;oo_unary_table op = [&#10;&#9;&#9;[this.Pair label (op.fn a) (op.fn b),&#10;&#9;&#9;&#9;true]&#10;&#9;];&#10;}&#10;&#10;Pair_new x = Pair x.label (to_image x.targets.value) (to_image x.object.value);&#10;&#10;Apply_ct ct p = class &#10;&#9;Pair label targets object {&#10;&#9;_vislevel = 2;&#10;&#10;&#9;label = p.label;&#10;&#9;targets = p.targets / ct;&#10;&#9;object = p.object / ct; &#10;&#10;}" name="specden" caption="spectral density" filename="$HOME/GIT/bm-workspaces/bm-workspaces2.ws">
    ...
    <Column x="2037" y="0" open="true" selected="false" sform="false" next="1" name="A" caption="match brightness of UV to vis">
      <Subcolumn vislevel="3">
        <Row popup="false" name="A7">
          <Rhs vislevel="3" flags="7">
            <Matrix/>
    ...
    <Column x="1268" y="0" open="true" selected="true" sform="false" next="1" name="C" caption="get the spectralon from the UV reflectance image">
      <Subcolumn vislevel="3">
  ...
  <Workspace window_x="365" window_y="109" window_width="710" window_height="866" view="WORKSPACE_MODE_REGULAR" scale="1" offset="0" lpane_position="426" lpane_open="false" rpane_position="400" rpane_open="false" local_defs="// private definitions for this workspace&#10;/* Make a colour from a temperature.&#10; */     &#10;colour_from_temp T  &#10;    = error (_ &quot;T out of range&quot;), T &lt; 1667 || T &gt; 25000&#10;    = Colour &quot;Yxy&quot; [50, x, y]&#10;{       &#10;    // Kim et all approximation&#10;    // see eg. http://en.wikipedia.org/wiki/Planckian_locus#Approximation&#10;    x&#10;        = -0.2661239 * 10 ** 9 / T ** 3 - 0.2343580 * 10 ** 6 / T ** 2 +&#10;            0.8776956 * 10 ** 3 / T + 0.179910, T &lt; 4000&#10;        = -3.0258469 * 10 ** 9 / T ** 3 + 2.1070379 * 10 ** 6 / T ** 2 +&#10;            0.2226347 * 10 ** 3 / T + 0.240390;&#10; &#10;    y &#10;        = -1.1063814 * x ** 3 - 1.34811020 * x ** 2 +&#10;            2.18555832 * x - 0.20219638, T &lt; 2222&#10;        = -0.9549476 * x ** 3 - 1.37418593 * x ** 2 +&#10;            2.09137015 * x - 0.16748867, T &lt; 4000&#10;        =  3.0817580 * x ** 3 - 5.87338670 * x ** 2 +&#10;            3.75112997 * x - 0.37001483;&#10;}&#10;&#10;temp_from_colour z&#10;    = T&#10;{&#10;    c = colour_transform_to Image_type.YXY (to_colour z);&#10;    x = c.value?1;&#10;    y = c.value?2;&#10;        &#10;    // McCamy's approximation, see eg. &#10;    // http://en.wikipedia.org/wiki/Color_temperature#Approximation&#10;&#10;    xe = 0.332;&#10;    ye = 0.1858;&#10;    n = (x - xe) / (y - ye);&#10;    T = -449 * n ** 3 + 3525 * n ** 2 - 6823.3 * n + 5520.33;&#10;}   &#10;&#10;" name="uvlkm" caption="Kubelka-Munk processing of UVL image" filename="$HOME/GIT/bm-workspaces/bm-workspaces2.ws">
    ...
    <Column x="574" y="0" open="true" selected="false" sform="false" next="6" name="I" caption="back to RGB">
      <Subcolumn vislevel="3">
        <Row popup="false" name="I1">
          <Rhs vislevel="2" flags="5">
  ...
  <Workspace window_x="365" window_y="109" window_width="710" window_height="866" view="WORKSPACE_MODE_REGULAR" scale="1" offset="0" lpane_position="400" lpane_open="false" rpane_position="100" rpane_open="false" local_defs="// private definitions for this workspace&#10;" name="results" caption="all the finished images" filename="$HOME/GIT/bm-workspaces/bm-workspaces2.ws">
  ...
  <Workspace window_x="365" window_y="109" window_width="710" window_height="866" view="WORKSPACE_MODE_REGULAR" scale="1" offset="0" lpane_position="400" lpane_open="false" rpane_position="100" rpane_open="false" local_defs="// private definitions for this workspace&#10;" name="tab2" caption="Default empty tab" filename="$HOME/GIT/bm-workspaces/bm-workspaces2.ws">
